            ...
            <form onSubmit={handleSubmit} className="askAquestion-wrapper">
                <div className="left-side">
                    ...
                    <div className="message-box second-box">
                        ...
                        <div className="imageMessage-box">
                            ...
                            <div className="text-div">
                                ...
                                <p>Lembre-se sempre de usar palavras-chave, para a sua pergunta ter mais chance de aparecer em pesquisas dos usuários.</p>
                            </div>
                        </div>
                    </div>
                    <div className="question-details">
                        <h6>Detalhes da pergunta</h6>
                        <p>Introduza o problema e desenvolva o que você colocou no título. Mínimo de 20 caracteres.</p>
                    ...
                    <div className="question-details">
                        ...
                        <p>Descreva o que você tentou, o que era para acontecer e o que realmente aconteceu (como o erro, por exemplo). Mínimo de 20 caracteres.</p>
